/**
 * Client profile screen — Phase 04 Plan 06 (PROF-01).
 *
 * Full profile editing: avatar (camera/library upload, square crop) + name edit,
 * with the existing sign-out preserved. Each user edits only their own doc (D-07).
 *
 * Data layer: useUser (name + photoURL), useUpdateProfile (name/photoURL write),
 * storage.service.uploadProfilePhoto (Storage upload). Photo capture via
 * expo-image-picker (allowsEditing, aspect [1,1], quality 0.7, mediaTypes 'images').
 */
