...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/.gsd-surface.json`
(sibling to `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/skills`).
...
`/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/.gsd-surface.json`
Install profile marker: `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/.gsd-profile`
Skill dirs: `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/skills/gsd-*/`
Engine module: `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
