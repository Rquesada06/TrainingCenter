...
```
Agent(
  prompt="Read /Users/FF-rodrigo/Documents/Personal/LauFit/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/get-shit-done/templates/SECURITY.md`
