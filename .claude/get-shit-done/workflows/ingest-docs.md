...
```bash
INIT=$(node "/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
