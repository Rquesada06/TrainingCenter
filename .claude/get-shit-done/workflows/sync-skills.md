...
INSTALL_JS_GLOBAL="/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/FF-rodrigo/Documents/Personal/LauFit/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
