...
- **Global scope**: `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/notes/`)
...
2. Glob `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/notes/` — works in any directory
