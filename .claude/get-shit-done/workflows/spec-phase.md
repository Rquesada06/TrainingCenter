...
```bash
INIT=$(node "/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/FF-rodrigo/Documents/Personal/LauFit/.claude/get-shit-done/templates/spec.md.
