...
- [x] 05-02-PLAN.md — Wave-0 pure units: sessionFinalize + prefill + timer libs, loggedExercise zod, sessionStore loggedSets extension + session types (LOG-01..04, TIMR-03) (Wave 0)

**Wave 1** *(blocked on Wave 0 — logging UI and builder touch disjoint trees → parallel)*

- [x] 05-03-PLAN.md — Per-set logging UI: SetRow + RpeStepper + session.tsx prefill/finalize wiring (LOG-01..04) (Wave 1)
- [x] 05-04-PLAN.md — Trainer builder prescription: rep range + target RPE + Timed toggle in RoutineExerciseRow + RoutineBuilder seed (PRES-01/02/03) (Wave 1)
