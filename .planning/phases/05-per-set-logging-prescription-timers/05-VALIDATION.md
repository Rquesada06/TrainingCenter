...
**Approval:** approved 2026-06-05 (gsd-plan-checker — plans satisfy the Wave-0 contract). `wave_0_complete` flips true once Wave 0 tests are written + green during execution.
